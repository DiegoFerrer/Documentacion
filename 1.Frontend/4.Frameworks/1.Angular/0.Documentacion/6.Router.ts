...
//? ng g m nameModule --route=nameComponent -m app-routing.module.ts
// No es más que la generación de un nuevo módulo pero con el flag --route= que le indica al CLI que debe tratarlo como una nueva ruta. Este súper comando genera dos módulos, un componente y además los registra automáticamente.

{
    path: 'about',
    loadChildren: () => import('./nameModule/nameModule.module').then(m => m.nameModule),
  },

  //? otra forma: https://mugan86.medium.com/trabajando-con-lazy-loading-en-angular-8-e1611ce2c46f
	
////****************** */ 
//todo,  SE DEBE PONER UN GUARD CON UN CAN LOAD EN ESTOS MODULOS ASINCRONOS
...
//todo,  en about-routing:
{
	path: '',
	component: aboutComponent,
	canActivatedChild: [CanActivateGuard],
	Children: [
		path: 'pruebas', // about/pruebas
		component: pruebas
	]
}
//todo, SI SE QUIERE HACER UNA REDIRECCION DIRECTAMENTE A UNA RUTA HIJA:
{
	path: '',
	pathMatch: full,
	redirecTo: 'ruta',
	Children: [
		path: 'ruta', // about/ruta
...
//// ##########################################################################################################################
//? 					REDIRECCIONAR A RUTA EXTERNA

http://freaktiful.es/2019/11/05/minitip-angular-redireccionar-a-una-pagina-externa-usando-router/