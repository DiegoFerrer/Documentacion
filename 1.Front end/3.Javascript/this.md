...
this: es una variable especial que representa al objeto cuyo código se está ejecutando, el valor cambia depende el lugar donde nos encontramos, al valor que se le asigna a esta variable se lo conoce como CONTEXTO.
SE USA PARA ACCEDER AL CODIGO DEL OBJETO QUE ESTAMOS USANDO EN ESE MOMENTO.

Si se usa arrow function ,no se modifica el valor de this ,ya que con las funciones comunes al acceder al contexto se cambia el valor. Lo mismo pasa con los settimeout , con las funciones comunes cambia el contexto de this y tira un undefinded

cuando se envie una funcion como argumento de otra funcion, o método de un objeto y queres mantener el valor de this, se recomienda usar arrow function		

	*/

function ejectuar(function) {	// esta funcion ejecuta una funcion recibida por parametro									
}	
...
ejecutar(tutor.nombreCompleto) // esto devuelve undefinded ya que no respesta el contexto de this.	

// Se puede arreglar utilizando arrow functions
